...
- `src/updatemenow/defaults/sources.yaml` — packaged default source catalog
  used when no local config exists.
- `src/updatemenow/defaults/keywords.yaml` — packaged default keyword and
  vendor watchlists used when no local config exists.
- `config/sources.yaml` — editable source catalog created by `umn config init`.
- `config/keywords.yaml` — editable keyword and vendor watchlists created by
  `umn config init`.
